              ...
              <div className="flex-1 flex flex-col min-h-0">
                ...
                <div className="flex-1">
                  <div className="p-6 space-y-10">
                    {/* Highlights */}
                    {Array.isArray(active.highlights) &&
                        ...
                        >
                          ...
                          <ul className="space-y-3 list-none">
                            {active.highlights.map((highlight, i) => (
                              <li
                                key={i}
                                className="flex items-start gap-3 text-gray-700 dark:text-gray-300 text-[15px] leading-relaxed"
                              >
                    ...
                    {(active.technologies || active.tech) && (
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-3">
                          {(Array.isArray(active.technologies)
                            ? active.technologies
                            : Array.isArray(active.tech)
                            ? active.tech
                            : String(active.technologies || active.tech).split(
                                /\s*,\s*/
                              )
                          )
                            .filter(Boolean)
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className="flex-shrink-0 w-[280px] sm:w-[280px] md:w-[300px] h-[320px] snap-start p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl rounded-2xl cursor-pointer transition-all duration-300 hover:border-indigo-200 dark:hover:border-indigo-700"
            >
              <div className="flex flex-col h-48 overflow-auto">
                ...
                <div className="flex-1">
                  <motion.h3
                    ...
                    className="font-bold text-gray-900 dark:text-white text-lg mb-3 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors line-clamp-2"
                  >
                  ...
                  <div className="mb-2">
                    <div className="flex flex-wrap gap-2">
                      {(Array.isArray(project.technologies)
                        ...
                        ? project.tech
                        : String(project.technologies || project.tech).split(
                            /\s*,\s*/
                          )
                      )
                        .filter(Boolean)
                        ...
                        .map((tech, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 text-xs rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border border-indigo-200 font-medium"
                          >
                            {tech}
                          </span>
                        ))}
                      {(Array.isArray(project.technologies)
                        ...
                        <span className="px-3 py-1 text-xs rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border border-indigo-200 font-medium">
                          +
                          {(Array.isArray(project.technologies)
                            ? project.technologies
                            : Array.isArray(project.tech)
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {project.github && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="px-2 py-2 text-xs rounded-full font-semibold text-white bg-gradient-to-r from-gray-700 to-gray-900 hover:from-black hover:to-gray-800 transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-1"
                  ...
                  {project.demo && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="px-2 py-2 text-xs rounded-full font-semibold text-white bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-1"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <svg
                        className="w-3 h-3"
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 text-xs rounded-full font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 shadow-md hover:shadow-lg flex items-center gap-1"
                  >
                    <svg
                      className="w-3 h-3"
                      fill="none"
